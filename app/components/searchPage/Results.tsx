    ...
    <>
      <div className="flex flex-row items-center justify-between px-10 py-5">
        <h1 className=" text-black text-[18px] font-bold">
          {risultati} risultati di annunci
        </h1>
        <div className="flex flex-row items-center gap-x-5 ">
          ...
          <button
            ...
            className={`flex items-center justify-center ${
              clickedButtons === 1 ? "border-2 border-[#1F1695]" : "border-0"
            } bg-[#DFF4FB] rounded-full w-[50px] h-[50px]`}
          >
          ...
          <button
            ...
            className={`flex items-center justify-center ${
              clickedButtons === 2 ? "border-2 border-[#1F1695]" : "border-0"
            } bg-[#DFF4FB] rounded-full w-[50px] h-[50px]`}
          >
      ...
      <div className="w-full h-full pb-[110px] px-10 py-5 overflow-y-scroll scrollbar-hide">
        <div
          className={`flex ${
            clickedButtons === 1 ? "flex-col" : "flex-row gap-x-5"
          } gap-y-5 py-5 `}
        >
